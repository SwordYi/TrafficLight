...
void CreateArrowPoint()
{
	for (int i = 0; i < 3; i++)
	{
		...
		arrow[i][3].x = arrow[i][2].x + radius * 4 / 10;	arrow[i][3].y = cc[i].y + radius * 8 / 10;
		arrow[i][4].x = arrow[i][1].x + radius * 4 / 10;	arrow[i][4].y = cc[i].y;
		arrow[i][5].x = arrow[i][0].x + radius * 4 / 10;	arrow[i][5].y = cc[i].y - radius * 8 / 10;
		arrow[i][6].x = cc[i].x - radius *  4 / 20;			arrow[i][6].y = cc[i].y - radius * 7 / 40;
		arrow[i][7].x = cc[i].x + radius * 18 / 20;			arrow[i][7].y = cc[i].y + radius * 7 / 40;
	}
	for (int i = 6; i < 9; i++)
	{
		...
		arrow[i][3].y = arrow[i][2].y + radius * 4 / 10;	arrow[i][3].x = cc[i].x + radius * 8 / 10;
		arrow[i][4].y = arrow[i][1].y + radius * 4 / 10;	arrow[i][4].x = cc[i].x;
		arrow[i][5].y = arrow[i][0].y + radius * 4 / 10;	arrow[i][5].x = cc[i].x - radius * 8 / 10;
		arrow[i][6].y = cc[i].y - radius *  4 / 20;			arrow[i][6].x = cc[i].x - radius * 7 / 40;
		arrow[i][7].y = cc[i].y + radius * 18 / 20;			arrow[i][7].x = cc[i].x + radius * 7 / 40;
	}
}
